...
def countdown(game):
    while True:
        ...
        graphics.draw_timer(game.time[get_oppisite_color(player)], graphics.oppounent_timer_pos[0],
                            graphics.oppounent_timer_pos[1])
        game = n.get(get)
...
def main():
    ...
    # graphics.small_message("Player " + player, WHITE, graphics.squaresize * 4 - graphics.squaresize * 0.1,
    #                        graphics.squaresize * 8 + graphics.border * 1.1)
    #
